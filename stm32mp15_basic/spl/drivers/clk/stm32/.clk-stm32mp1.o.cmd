cmd_spl/drivers/clk/stm32/clk-stm32mp1.o := arm-linux-gnueabi-gcc -Wp,-MD,spl/drivers/clk/stm32/.clk-stm32mp1.o.d -nostdinc -isystem /usr/lib/gcc-cross/arm-linux-gnueabi/11/include -Ispl/include -Iinclude  -I../include    -I../arch/arm/include -include ../include/linux/kconfig.h  -I../drivers/clk/stm32 -Ispl/drivers/clk/stm32 -D__KERNEL__ -D__UBOOT__ -DCONFIG_SPL_BUILD -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-strict-aliasing -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -Wno-pointer-sign -Wno-stringop-truncation -Wno-zero-length-bounds -Wno-array-bounds -Wno-stringop-overflow -Wno-maybe-uninitialized -fmacro-prefix-map=../= -gdwarf-4 -fstack-usage -Wno-format-nonliteral -Wno-address-of-packed-member -Wno-unused-but-set-variable -Werror=date-time -Wno-packed-not-aligned -ffunction-sections -fdata-sections -fno-stack-protector -D__ARM__ -Wa,-mimplicit-it=always -mthumb -mthumb-interwork -mabi=aapcs-linux -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -mgeneral-regs-only -pipe -march=armv7-a -D__LINUX_ARM_ARCH__=7 -mtune=generic-armv7-a  -I../arch/arm/mach-stm32mp/include    -DKBUILD_BASENAME='"clk_stm32mp1"'  -DKBUILD_MODNAME='"clk_stm32mp1"' -c -o spl/drivers/clk/stm32/clk-stm32mp1.o ../drivers/clk/stm32/clk-stm32mp1.c

source_spl/drivers/clk/stm32/clk-stm32mp1.o := ../drivers/clk/stm32/clk-stm32mp1.c

deps_spl/drivers/clk/stm32/clk-stm32mp1.o := \
...
spl/drivers/clk/stm32/clk-stm32mp1.o: $(deps_spl/drivers/clk/stm32/clk-stm32mp1.o)
