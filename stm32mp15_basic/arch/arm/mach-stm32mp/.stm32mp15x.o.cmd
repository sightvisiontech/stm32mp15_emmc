cmd_arch/arm/mach-stm32mp/stm32mp15x.o := arm-linux-gnueabi-gcc -Wp,-MD,arch/arm/mach-stm32mp/.stm32mp15x.o.d -nostdinc -isystem /usr/lib/gcc-cross/arm-linux-gnueabi/11/include -Iinclude  -I../include    -I../arch/arm/include -include ../include/linux/kconfig.h  -I../arch/arm/mach-stm32mp -Iarch/arm/mach-stm32mp -D__KERNEL__ -D__UBOOT__ -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-strict-aliasing -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -Wno-pointer-sign -Wno-stringop-truncation -Wno-zero-length-bounds -Wno-array-bounds -Wno-stringop-overflow -Wno-maybe-uninitialized -fmacro-prefix-map=../= -gdwarf-4 -fstack-usage -Wno-format-nonliteral -Wno-address-of-packed-member -Wno-unused-but-set-variable -Werror=date-time -Wno-packed-not-aligned -D__ARM__ -Wa,-mimplicit-it=always -mthumb -mthumb-interwork -mabi=aapcs-linux -mword-relocations -fno-pic -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -mgeneral-regs-only -pipe -march=armv7-a -D__LINUX_ARM_ARCH__=7 -mtune=generic-armv7-a  -I../arch/arm/mach-stm32mp/include    -DKBUILD_BASENAME='"stm32mp15x"'  -DKBUILD_MODNAME='"stm32mp15x"' -c -o arch/arm/mach-stm32mp/stm32mp15x.o ../arch/arm/mach-stm32mp/stm32mp15x.c

source_arch/arm/mach-stm32mp/stm32mp15x.o := ../arch/arm/mach-stm32mp/stm32mp15x.c

deps_arch/arm/mach-stm32mp/stm32mp15x.o := \
...
arch/arm/mach-stm32mp/stm32mp15x.o: $(deps_arch/arm/mach-stm32mp/stm32mp15x.o)
