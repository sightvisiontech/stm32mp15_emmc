cmd_tools/generated/env/embedded.o := cc -Wp,-MD,tools/generated/env/.embedded.o.d -Itools -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu11 -DCONFIG_FIT_SIGNATURE -DCONFIG_FIT_SIGNATURE_MAX_SIZE=0xffffffff -DCONFIG_FIT_CIPHER -include ../include/compiler.h -idirafterinclude -idirafter../include -idirafter../arch/arm/include  -I../scripts/dtc/libfdt  -I../tools -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE -c -o tools/generated/env/embedded.o tools/generated/env/embedded.c
