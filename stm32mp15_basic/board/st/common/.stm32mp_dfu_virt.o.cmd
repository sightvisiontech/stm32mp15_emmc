cmd_board/st/common/stm32mp_dfu_virt.o := arm-linux-gnueabi-gcc -Wp,-MD,board/st/common/.stm32mp_dfu_virt.o.d -nostdinc -isystem /usr/lib/gcc-cross/arm-linux-gnueabi/11/include -Iinclude  -I../include    -I../arch/arm/include -include ../include/linux/kconfig.h  -I../board/st/common -Iboard/st/common -D__KERNEL__ -D__UBOOT__ -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-strict-aliasing -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -Wno-pointer-sign -Wno-stringop-truncation -Wno-zero-length-bounds -Wno-array-bounds -Wno-stringop-overflow -Wno-maybe-uninitialized -fmacro-prefix-map=../= -gdwarf-4 -fstack-usage -Wno-format-nonliteral -Wno-address-of-packed-member -Wno-unused-but-set-variable -Werror=date-time -Wno-packed-not-aligned -D__ARM__ -Wa,-mimplicit-it=always -mthumb -mthumb-interwork -mabi=aapcs-linux -mword-relocations -fno-pic -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -mgeneral-regs-only -pipe -march=armv7-a -D__LINUX_ARM_ARCH__=7 -mtune=generic-armv7-a  -I../arch/arm/mach-stm32mp/include    -DKBUILD_BASENAME='"stm32mp_dfu_virt"'  -DKBUILD_MODNAME='"stm32mp_dfu_virt"' -c -o board/st/common/stm32mp_dfu_virt.o ../board/st/common/stm32mp_dfu_virt.c

source_board/st/common/stm32mp_dfu_virt.o := ../board/st/common/stm32mp_dfu_virt.c

deps_board/st/common/stm32mp_dfu_virt.o := \
    $(wildcard include/config/pmic/stpmic1.h) \
    $(wildcard include/config/cmd/stm32prog/usb.h) \
...
board/st/common/stm32mp_dfu_virt.o: $(deps_board/st/common/stm32mp_dfu_virt.o)
